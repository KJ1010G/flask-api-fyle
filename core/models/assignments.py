...
class Assignment(db.Model):
    ...
    @classmethod
    def upsert(cls, assignment_new: 'Assignment', principal: Principal):
        if assignment_new.id is not None:
            ...
            assertions.assert_auth(assignment.student_id == principal.student_id, 'This assignment belongs to some other student. You cannot update it')
            assignment.content = assignment_new.content
        else:
            assignment = assignment_new
            assignment.student_id = principal.student_id
    ...
    def gradeAssignment(cls, _id, grade, principal: Principal):
        ...
        assertions.assert_valid(grade is not None, 'grade is required for grading')
